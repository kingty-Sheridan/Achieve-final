...
<body>
    ...
    <p>
        <a href="reset-password.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>" class="btn btn-warning">Reset Your Password</a>
  ...
  echo
   "<tr>
    ...
    <td>{$row['Date']}</td>
     ...
     <td><button type='button' id='pay' onclick= 'window.location.href='{$row['paylink']}''>Pay Now</button></td>
    </tr>";
...
?>
     <tr>
        <td>Success By Design</td>
         <td>Today</td>
        <td><button type='button' id='pay' onclick="window.location.href='http://142.55.32.86:50231/choice.html'">Pay Now</button></td>
    </tr>
</table>
    <h1>Enrolled</h1>
<table border="1" align="center">
